...
//	private ScriptIntrinsicBlur intrinsic;
	...
	private Runnable drawRunnable = new Runnable() {
		...
		public void run() {
			...
			if (mSR != null) { // finish() could have been called from the BroadcastReceiver
				...
				//buf.append("{:.2f}".format("%.2f", mCpuStat.getTotalCpuUsage()));

				//mTVCPUTotalP.setText(String.valueOf(buf.toString()));


				mCorePerf.setText(mSR.mCpuStat.toString());
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mCpuStat.update();
		mCorePerf=(TextView) findViewById(R.id.TVCorePerf);
